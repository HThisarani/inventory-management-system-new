    ...
    <AuthenticatedLayout>
        ...
        <div class="py-6 px-4">
            ...
            <input
                ...
                class="border border-gray-300 rounded-lg px-4 py-3 mb-6 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 shadow-sm"
            />
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-gradient-to-r from-gray-50 to-gray-100">
                            ...
                            <th class="px-6 py-4 text-center text-sm font-semibold text-gray-700 border-b border-gray-200">History</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="item in items" :key="item.id" class="hover:bg-blue-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 text-center">
                                <a
                                    ...
                                    class="inline-block px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md"
                                >
                                    View
                                </a>
                            </td>
